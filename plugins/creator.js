...
if (command == 'creator') {
  ...
  const sentMsg = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 🥺`, `maxxyofc@gmail.com`, `🇮🇩 Indonesia`, `🚀 https://Frezzy-XD.github.io/`, `👤 Owner Gua Ganteng kok`],
