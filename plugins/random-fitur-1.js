...
handler.command = handler.help = ['jadian2', 'menikah', 'metercinta', 'bertanya', 'asmaulhusna', '', 'memeindo', 'stimker', 'randommeme', 'memedarkjoke', 'beasiswa', 'apkdown', 'proxysite', 'mirrorcreator', 'ouo', 'ouoshort', 'shortlink', 'shortlink2', 'shortlink3', 'shortlink4', 'tenor', 'sl']
handler.tags = ['random']
